...
This guide describes the style standards for creating OpenSearch content.

Our content follows the [Microsoft Writing Style Guide](https://docs.microsoft.com/en-us/style-guide/welcome/), [The Chicago Manual of Style](https://www.chicagomanualofstyle.org/home.html), and [Merriam-Webster](https://www.merriam-webster.com/). However, this guide and [TERMS.md](TERMS.md) take precedence over those references.
